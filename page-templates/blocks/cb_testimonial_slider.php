<?php
/**
 * Template for displaying the testimonial slider block.
 *
            ...
            <div class="splide__track">
                ...
                <li class="testimonials__testimonial splide__slide">
                    <div class="testimonials__body mx-auto">
                        <div class="testimonials__content mb-2"><?= wp_kses_post( get_field( 'testimonial', get_the_ID() ) ); ?></div>
                        <div class="testimonials__cite">
                            <div><strong><?= esc_html( get_the_title() ); ?></strong></div>
                            <div><?= esc_html( get_field( 'position', get_the_ID() ) ); ?>, <?= esc_html( get_field( 'company', get_the_ID() ) ); ?></div>
                        </div>
                    </div>
                </li>
                		<?php
